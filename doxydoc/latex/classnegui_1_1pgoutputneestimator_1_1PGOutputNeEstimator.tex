...
Definition at line 218 of file pgoutputneestimator.\+py.
...
292                         \textcolor{comment}{#so we use the default split to}
293                         \textcolor{comment}{#list only non-space as items:  }
294                         ls\_vals=s\_line.strip().split() 
295                         \textcolor{comment}{#first col is the pop name}
296                         self.\_\_parsed\_nodat\_output.append( [ s\_currpop ] \(\backslash\)
297                                 + [ s\_val \textcolor{keywordflow}{for} s\_val \textcolor{keywordflow}{in} ls\_vals ] )
298                     \textcolor{comment}{#end if end-table line, else data}
299                 \textcolor{comment}{#end if header's been found and we're past the non-date line}
300             \textcolor{comment}{#end if pop line else header line, else some other line}
301         \textcolor{comment}{#end for each line in nodat file}
302 
303         o\_file.close()
...
Definition at line 75 of file pgoutputneestimator.\+py.
