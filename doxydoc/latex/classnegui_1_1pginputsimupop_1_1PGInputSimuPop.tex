...
Definition at line 28 of file pginputsimupop.\+py.
...
Definition at line 416 of file pginputsimupop.\+py.


\begin{DoxyCode}
416             s\_config\_file\_section\_name ):
417         \textcolor{stringliteral}{'''}
418 \textcolor{stringliteral}{        If user wants to add a parameter not in the current set of params as read}
419 \textcolor{stringliteral}{        in from the config file source of this instance, this def will both add the }
420 \textcolor{stringliteral}{        param and value, plus update the member dictionaries that facilitate}
421 \textcolor{stringliteral}{        writing a new config file that includes this parameter.  Note that the}
422 \textcolor{stringliteral}{        arg s\_config\_file\_option\_name is necessitated by Tiago's standards in }
423 \textcolor{stringliteral}{        his config files, as he often uses an attribute name different}
424 \textcolor{stringliteral}{        from the option name that gives the value.}
425 \textcolor{stringliteral}{        '''}
426         setattr( self, s\_attribute\_name, v\_attribute\_value )
427         self.\hyperlink{classnegui_1_1pginputsimupop_1_1PGInputSimuPop_a27abd811d6b6108a9593372c3b0c7881}{\_\_update\_attribute\_config\_file\_info}( s\_attribute\_name, 
      s\_config\_file\_section\_name, 
428                 s\_config\_file\_option\_name )
...
Definition at line 467 of file pginputsimupop.\+py.


\begin{DoxyCode}
467     \textcolor{keyword}{def }\hyperlink{classnegui_1_1pginputsimupop_1_1PGInputSimuPop_a099e2f01dabe86e713df7519a08fecca}{getDictParamValuesByAttributeName}( self ):
468         \textcolor{stringliteral}{'''}
469 \textcolor{stringliteral}{        Note that this algorithm simply skips}
470 \textcolor{stringliteral}{        over paramters with names in the PGParamSet}
471 \textcolor{stringliteral}{        object, but without a corresponding attribute}
472 \textcolor{stringliteral}{        in this (self) instance.}
473 \textcolor{stringliteral}{        '''}
474         dv\_param\_values\_by\_name=\{\}
475 
476         \textcolor{keywordflow}{if} self.\hyperlink{classnegui_1_1pginputsimupop_1_1PGInputSimuPop_a0a737393cb4d1c66062f9403296c7f19}{\_\_param\_names} \textcolor{keywordflow}{is} \textcolor{keywordtype}{None}:
477             s\_msg=\textcolor{stringliteral}{"In PGInputSimuPop instance, can't get dict of param/values"} \(\backslash\)
478                     + \textcolor{stringliteral}{": missing the required PGParamSet object."}
479             \textcolor{keywordflow}{raise} Exception( s\_msg )
480         \textcolor{comment}{#end if no parma set object}
481 
482         ls\_attribute\_names=self.param\_names.shortnames
483 
484         \textcolor{keywordflow}{for} s\_name \textcolor{keywordflow}{in} ls\_attribute\_names:
485             \textcolor{keywordflow}{if} hasattr( self, s\_name ):
486                 dv\_param\_values\_by\_name[ s\_name ]=getattr( self, s\_name )
487             \textcolor{comment}{#end if hasattr}
488         \textcolor{comment}{#end for each param name}
489         
490         \textcolor{keywordflow}{return} dv\_param\_values\_by\_name
\end{DoxyCode}
...
Definition at line 633 of file pginputsimupop.\+py.
...
Definition at line 718 of file pginputsimupop.\+py.
