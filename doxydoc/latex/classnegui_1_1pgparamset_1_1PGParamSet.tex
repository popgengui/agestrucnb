...
Definition at line 157 of file pgparamset.\+py.


\begin{DoxyCode}
157     \textcolor{keyword}{def }\hyperlink{classnegui_1_1pgparamset_1_1PGParamSet_a598ea6a166f56fe5be01f86d4d8c91ba}{\_\_init\_\_}( self, s\_file\_with\_param\_names = None ):
158 
159         \textcolor{stringliteral}{'''}
160 \textcolor{stringliteral}{        If provided, arg s\_file\_with\_param\_names}
161 \textcolor{stringliteral}{        should be a file with 2 or more strings on each line,}
162 \textcolor{stringliteral}{        tab-separated, the first value giving the short}
163 \textcolor{stringliteral}{        name of the parameter, the second the long (full)}
164 \textcolor{stringliteral}{        name, the third (if present)}
165 \textcolor{stringliteral}{        '''}
166         self.\hyperlink{classnegui_1_1pgparamset_1_1PGParamSet_aafa67026a09aa523151728cba95e0d6d}{\_\_file\_with\_param\_names}=s\_file\_with\_param\_names
167         self.\hyperlink{classnegui_1_1pgparamset_1_1PGParamSet_aa13eaff9049bc16fa4090c8b85915f3c}{\_\_tags\_by\_shortname}=\{\}
168 
169         \textcolor{keywordflow}{if} s\_file\_with\_param\_names \textcolor{keywordflow}{is} \textcolor{keywordflow}{not} \textcolor{keywordtype}{None}:
170             self.\hyperlink{classnegui_1_1pgparamset_1_1PGParamSet_abc19f133ab3ecc86ec8099549b0b45bb}{\_\_init\_from\_file}( s\_file\_with\_param\_names )
171         \textcolor{comment}{#end if file name given}
...
Definition at line 414 of file pgparamset.\+py.


\begin{DoxyCode}
414     \textcolor{keyword}{def }\hyperlink{classnegui_1_1pgparamset_1_1PGParamSet_aef97e7ee992a99258a6bbd7b7bf7c5fe}{tag}( self, s\_name ):
415         \textcolor{stringliteral}{'''}
416 \textcolor{stringliteral}{        param s\_name can be either among the }
417 \textcolor{stringliteral}{        short or long names (or both). Shortnames}
418 \textcolor{stringliteral}{        are checked first.  First instance of name}
419 \textcolor{stringliteral}{        provides its tag as the return value.}
420 \textcolor{stringliteral}{        '''}
421         s\_val=\textcolor{keywordtype}{None}
422 
423         \textcolor{keywordflow}{if} s\_name \textcolor{keywordflow}{in} self.\hyperlink{classnegui_1_1pgparamset_1_1PGParamSet_aa13eaff9049bc16fa4090c8b85915f3c}{\_\_tags\_by\_shortname}:
424             s\_val = self.\hyperlink{classnegui_1_1pgparamset_1_1PGParamSet_aa13eaff9049bc16fa4090c8b85915f3c}{\_\_tags\_by\_shortname}[ s\_name ]
425         \textcolor{keywordflow}{else}:
426             s\_msg=\textcolor{stringliteral}{"In PGParamSet instance, def tag(), no tag "} \(\backslash\)
427                     + \textcolor{stringliteral}{"associated with "} \(\backslash\)
428                     + \textcolor{stringliteral}{"param name, "} + s\_name + \textcolor{stringliteral}{"."}
429             \textcolor{keywordflow}{raise} Exception ( s\_msg )
430         \textcolor{comment}{#end if tag in short else if tag in long}
431 
432         \textcolor{keywordflow}{return} s\_val
\end{DoxyCode}
...
Definition at line 483 of file pgparamset.\+py.


\begin{DoxyCode}
483     \textcolor{keyword}{def }\hyperlink{classnegui_1_1pgparamset_1_1PGParamSet_a292c23c3d6349027f5c19eec70ea34f8}{tags}(self):
484         \textcolor{stringliteral}{'''}
485 \textcolor{stringliteral}{        returns a list of tags, without their associated}
486 \textcolor{stringliteral}{        param names (short or long).  Useful to get}
487 \textcolor{stringliteral}{        the set of unique tags if the tags categorize}
488 \textcolor{stringliteral}{        the paramset into groups}
489 \textcolor{stringliteral}{        '''}
490         ls\_tags=self.\_\_tags\_by\_shortname.values()
491         ls\_tags.sort()
492         \textcolor{keywordflow}{return} ls\_tags
\end{DoxyCode}
